...
public class LuaLoader implements JavaFunction, CoronaRuntimeListener {
    ...
    public int init(LuaState L) {
        ...
        Yodo1Advert.initSDK(activity, key);

        return 0;
    }

    public int setKey(LuaState L, String key) {
        this.applicationKey = L.checkString(1);
    ...
    @SuppressWarnings("unused")
    private class SetKeyWrapper implements NamedJavaFunction {
        @Override
